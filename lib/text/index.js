 ...
 * @param callback
 */
exports.search = function (db, collection, condition, option, freq, field, callback) {
...
exports.batch = function (db, target, source, field, callback) {
  ...
  cursor.count(function (err, count) {
    ...
    cursor.each(function (err, item) {
      if (item) {
        exports.patch(db, target.collection, item._id, collection, source.attribute, field, function (err) {
          if (--c == 0) {
            return callback(err, count);
          }
        });
