...
exports.tfiof = function (db, target, source, field, callback) {
  ...
  condition[source.attribute] = {$exists: 1};

  var f = {};
  f[source.attribute] = 1;
  ...
  cursor.count(function (err, count) {
    ...
    cursor.each(function (err, item) {
      if (item !== null) {
        var x = extend.getValue(item, source.attribute);
                exports.to_tfiof(x, field, db.collection(target.collection), function (err, x) {
          var obj = {};
          obj[source.attribute] = x;
